...
class Adapter(BaseAdapter):
    ...
    def vqa_forward(self, feat_dict):
        frcn_feat = feat_dict['FRCN_FEAT']          # 获取 frcn_feat
        bbox_feat = feat_dict['BBOX_FEAT']          # 获取 bbox_feat

        img_feat_mask = make_mask(frcn_feat)        # 制作掩模
        img_feat = frcn_feat                        # 将frcn_feat赋给img_feat
