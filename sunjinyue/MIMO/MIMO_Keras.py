...
samples_dim_02 = 2
# 样本数据
x1 = rd.rand(samples_n, samples_dim_01)    # sss 3000行2列
...
y_1 = np.array(y_1)
y_1.shape
y_1 = np.expand_dims(y_1, axis=1)         # sss 扩展维度
y_1.shape
y_2 = np.array(y_2)
...
# 测试
print("测试结果：")
print("test_x1:", test_x1, "test_x2:", test_x2, "y:", test_y, 'Y:',np.sum(test_x1) + np.sum(test_x2))
