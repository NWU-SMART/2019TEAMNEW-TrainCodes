...
# 服务器
data_batch_1 = pickle.load(open("data_batch_1", 'rb'),encoding='bytes')
data_batch_2 = pickle.load(open("data_batch_2", 'rb'),encoding='bytes')
data_batch_3 = pickle.load(open("data_batch_3", 'rb'),encoding='bytes')
data_batch_4 = pickle.load(open("data_batch_4", 'rb'),encoding='bytes')
data_batch_5 = pickle.load(open("data_batch_5", 'rb'),encoding='bytes')
...
train_y = encoder .fit_transform(train_y)     # 将整型的类别标签转为onehot编码
