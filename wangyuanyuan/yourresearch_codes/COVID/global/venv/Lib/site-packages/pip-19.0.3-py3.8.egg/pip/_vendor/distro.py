...
class LinuxDistribution(object):
    ...
    This package creates a private Models-global instance of this class with
    default initialization arguments, that is used by the
    `consolidated accessor functions`_ and `single source accessor functions`_.
    By using default initialization arguments, that Models-global instance
    ...
    def _parse_os_release_content(lines):
        ...
        * lines: Iterable through the lines in the os-release file.
        ...
        # The shlex Models defines its `wordchars` variable using literals,
