'''Some helper functions for PyTorch, including:
    ...
    - set_lr : set the learning rate设置学习率
    - clip_gradient : clip gradient剪切渐变
'''
...
def progress_bar(current, total, msg=None):
    cur_len = int(TOTAL_BAR_LENGTH * (current + 1)/total)#当前长度
    rest_len = int(TOTAL_BAR_LENGTH - cur_len) - 1#剩余长度
