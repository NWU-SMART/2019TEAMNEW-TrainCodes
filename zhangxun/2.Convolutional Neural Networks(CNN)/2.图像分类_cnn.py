...
save_dir = 'E:\软件学习\深度学习\postgraduate study\数据集、模型、图片\2.CNN\saved_models_cnn\saved_models_cnn' #创建文件夹'saved_models_cnn'
model_name = 'keras_fashion_trained_model_test.h5' #模型名称
