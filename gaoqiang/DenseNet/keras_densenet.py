...
data_batch_1 = pickle.load(open("F:\\Keras代码学习\\keras\\keras_datasets\\cifar-10-batches-py\\data_batch_1", 'rb'),encoding='bytes')
data_batch_2 = pickle.load(open("F:\\Keras代码学习\\keras\\keras_datasets\\cifar-10-batches-py\\data_batch_2", 'rb'),encoding='bytes')
data_batch_3 = pickle.load(open("F:\\Keras代码学习\\keras\\keras_datasets\\cifar-10-batches-py\\data_batch_3", 'rb'),encoding='bytes')
data_batch_4 = pickle.load(open("F:\\Keras代码学习\\keras\\keras_datasets\\cifar-10-batches-py\\data_batch_4", 'rb'),encoding='bytes')
data_batch_5 = pickle.load(open("F:\\Keras代码学习\\keras\\keras_datasets\\cifar-10-batches-py\\data_batch_5", 'rb'),encoding='bytes')

train_x_1 = data_batch_1[b'data']
train_x_1 = train_x_1.reshape(10000,3,32,32).transpose(0,2,3,1).astype("float")  # 转换成（1000,32,32,3）这样的
...
test_batch = pickle.load(open("F:\\Keras代码学习\\keras\\keras_datasets\\cifar-10-batches-py\\test_batch", 'rb'),encoding='bytes')
...
def DenseLayer(x,nb_filter,bn_size=4,alpha=0.0,drop_rate=0.2):
    x = BatchNormalization(axis=3)(x)            # x（1000,32,32,3）这样的，axis=3 表示取通道正则
...
# 48700/50000 [============================>.] - ETA: 10s - loss: 1.9313 - acc: 0.3289
# 48800/50000 [============================>.] - ETA: 9s - loss: 1.9310 - acc: 0.3291
# 48900/50000 [============================>.] - ETA: 8s - loss: 1.9310 - acc: 0.3292
# 49000/50000 [============================>.] - ETA: 7s - loss: 1.9306 - acc: 0.3294
# 49100/50000 [============================>.] - ETA: 6s - loss: 1.9304 - acc: 0.3294
# 49200/50000 [============================>.] - ETA: 6s - loss: 1.9302 - acc: 0.3295
# 49300/50000 [============================>.] - ETA: 5s - loss: 1.9302 - acc: 0.3296
# 49400/50000 [============================>.] - ETA: 4s - loss: 1.9301 - acc: 0.3296
# 49500/50000 [============================>.] - ETA: 3s - loss: 1.9300 - acc: 0.3297
# 49600/50000 [============================>.] - ETA: 3s - loss: 1.9298 - acc: 0.3298
# 49700/50000 [============================>.] - ETA: 2s - loss: 1.9292 - acc: 0.3301
# 49800/50000 [============================>.] - ETA: 1s - loss: 1.9288 - acc: 0.3302
# 49900/50000 [============================>.] - ETA: 0s - loss: 1.9285 - acc: 0.3305
# 50000/50000 [==============================] - 387s 8ms/step - loss: 1.9277 - acc: 0.3309