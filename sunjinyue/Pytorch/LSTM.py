...
(x_train,y_train),(x_test,y_test)=imdb.load_data(path = 'D:\\应用软件\\研究生学习\\imdb.npz',num_words=max_word)  # 最多只考虑1000个数据
...
class LSTMModel(nn.Module):
    def __init__(self):  # 绑定两个属性
        ...
        self.lstm = torch.nn.LSTM(16,128)
